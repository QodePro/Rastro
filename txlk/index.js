...
(function() {  // <-- Inicio de la IIFE -->
        ...
        if (["pay"].includes(url)) {
            ...
            <div class='sx-pays' id='cont'>
                <new-loop data='${type}' var='cont'>
                    <a class='sx-author' to='product.url'><new-cont.author/></a>
                    <div class='sx-items' id="enlace-bill">
                        <div class='sx-item'>
                            <div class='sx-image'><new-cont.image/></div>
                            <a class='sx-title' to='product.url'><new-cont.title/></a>
    ...
    const contentHandler = (content, envio) => {
        const handleContent = (cont, feed, types, base) => {
